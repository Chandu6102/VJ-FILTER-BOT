...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this IKBRYTLINKZ bot to your group
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस आईकेब्राइटलिंक्ज़ बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ ഐകെബ്രൈറ്റ്ലിങ്ക്സ് ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ ಐಕೆಬ್ರೈಟ್ಲಿಂಕ್ಜ್ ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
Example:- /set_caption 📕 File Name: @IKBRYTLinkz {filename}
💾 Size: {filesize}
⏰ Duration: {duration}
