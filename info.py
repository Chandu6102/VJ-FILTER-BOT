...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002539760683 -1002613461457 -1002583558849').split()]  # For Multiple Id Use One Space Between Each.
