...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002612405575 -1002601417905').split()]  # For Multiple Id Use One Space Between Each.
