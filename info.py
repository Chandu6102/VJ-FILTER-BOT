...
PICS = (environ.get('PICS', 'https://iili.io/3VhhnWv.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002612405575').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002602051457')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://iili.io/3VhhnWv.jpg') # payment code picture url.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://kaviiyyappan666:9aUVgi0D55gyAKAJ@cluster0.lxtq62k.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'https://t.me/bdjdjdjdjdjdjhvd') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/IKBRYTMOVIES')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+CXdSFgRVbERmZDBl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+9ae8Fn5CGMZiN2U1') # Support Chat Link Without https:// or @
